;============================================================================
; dir4.asm - retrieve ls info from OS and print - eliminate directories and .  and ..
; John Schwartzman, Forte Systems, Inc.
; Mon Oct 28 12:52:10 PM EDT 2024
; Linux x86_64
;
...
.chdir:
	...
	test	rax, rax				; successfully changed dir?
...
.printFileType:
	cmp		al, DT_DIR				; only list non-directories
	je		.top_of_loop
